...
@WebServlet("/rutas-json-nofijas")
public class RutasNoFijasJsonServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = Conexion.getConexion()) {
            String query = "SELECT id_ruta, nombre_ruta, coordenadas, color, estado FROM rutas WHERE tipo_ruta = 3";
