...
@WebServlet("/rutas-json-mat")
public class RutasMatutinasJsonServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = Conexion.getConexion()) {
            // Agregar estado e id_ruta a la consulta
            String query = "SELECT id_ruta, nombre_ruta, coordenadas, color, estado FROM rutas WHERE tipo_ruta = 1";
